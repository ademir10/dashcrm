class AdvicesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @advice.save
        format.html { redirect_to @advice, notice: 'Tratativa criada com sucesso.' }
  ...
  def update
    respond_to do |format|
      if @advice.update(advice_params)
        format.html { redirect_to @advice, notice: 'Tratativa atualizada com sucesso.' }
  ...
  def destroy
    @advice.destroy
    respond_to do |format|
      format.html { redirect_to advices_url, notice: 'Tratativa excluida com sucesso.' }
  ...
  private
    ...
    def advice_params
      params.require(:advice).permit(:description)
    end
