...
class ResearchesControllerTest < ActionController::TestCase
  ...
  test "should create research" do
    assert_difference('Research.count') do
      post :create, research: { category_id: @research.category_id, cellphone: @research.cellphone, client: @research.client, user: @research.user }
    end
  ...
  test "should update research" do
    patch :update, id: @research, research: { category_id: @research.category_id, cellphone: @research.cellphone, client: @research.client, user: @research.user }
    assert_redirected_to research_path(assigns(:research))
  end
